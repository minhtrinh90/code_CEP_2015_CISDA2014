...
//============================ added =============================================
#define ID_NUM        4      // autonomous agent
...
#define angle1Cd 2*PI/3
#define angle1Ad 2*PI/3
#define angle1Bd 2*PI/3
...
float bearing_x_1, bearing_x_2, bearing_x_3;
float bearing_y_1, bearing_y_2, bearing_y_3;
...
float lat_dist_from_agent3;
float lng_dist_from_agent3;
