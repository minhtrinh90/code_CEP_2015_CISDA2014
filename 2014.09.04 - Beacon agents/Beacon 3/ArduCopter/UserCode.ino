...
//          lat_dist_from_leader = (float)(xb_data_f_l.data[0]) - (float)(g_gps->latitude%1000000);
//          lng_dist_from_leader = (float)(xb_data_f_l.data[1]) - (float)(g_gps->longitude%1000000);
//          estimated_velocity_x = 0.0;
//          estimated_velocity_y = 0.0;
//          ez_x = 0.0000010/2*lat_dist_from_leader*(lat_dist_from_leader*lat_dist_from_leader + lng_dist_from_leader*lng_dist_from_leader - desired_distance*desired_distance);
//          ez_y = 0.0000010/2*lng_dist_from_leader*(lat_dist_from_leader*lat_dist_from_leader + lng_dist_from_leader*lng_dist_from_leader - desired_distance*desired_distance);
//          control_input_x = estimated_velocity_x + ez_x;
//          control_input_y = estimated_velocity_y + ez_y;
//    
...
//          estimated_velocity_x = estimated_velocity_x + ez_x*0.01;
//          estimated_velocity_y = estimated_velocity_y + ez_y*0.01;
